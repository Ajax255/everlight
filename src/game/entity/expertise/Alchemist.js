...
export default class Alchemist {	
	constructor(lvl, modInt, modCon) {
		this.rolls = new Dice();
		this.skills = [ 'Appraise', 'Craft', 'Disable Device', 'Fly', 'Heal', 'Knowledge(arcana)',
			'Knowledge(nature)', 'Perception', 'Profession', 'Sleight of Hand', 'Spellcraft', 'Survival',
			'Use Magic Device' ];
	...
	lvlTwo(modInt, modCon) {
		...
		this.saves =[ 3, 3, 0 ];
		this.spellsLVL =[ 0, 2, 0, 0, 0, 0, 0, 0, 0, 0 ];
		this.skillPoints = 4 + modInt;
	...
	lvlThree(modInt, modCon) {
		...
		this.saves =[ 3, 3, 1 ];
		this.spellsLVL =[ 0, 3, 0, 0, 0, 0, 0, 0, 0, 0 ];
		this.skillPoints = 4 + modInt;
		this.hitPoints = this.rolls.eightSided() + modCon;
	}
	...
	lvlFour(modInt, modCon) {
		...
		this.saves =[ 4, 4, 1 ];
		this.spellsLVL =[ 0, 3, 1, 0, 0, 0, 0, 0, 0, 0 ];
		this.skillPoints = 4 + modInt;
		this.hitPoints = this.rolls.eightSided() + modCon;
	}
	...
	lvlFive(modInt, modCon) {
		this.baseAttackBonus =[ 3, 0, 0, 0 ];
		this.saves =[ 4, 4, 1 ];
		this.spellsLVL =[ 0, 4, 2, 0, 0, 0, 0, 0, 0, 0 ];
		this.skillPoints = 4 + modInt;
		this.hitPoints = this.rolls.eightSided() + modCon;
	}
	...
	lvlSix(modInt, modCon) {
		...
		this.saves =[ 5, 5, 2 ];
		this.spellsLVL =[ 0, 4, 3, 0, 0, 0, 0, 0, 0, 0 ];
		this.skillPoints = 4 + modInt;
		this.hitPoints = this.rolls.eightSided() + modCon;
	}
	...
	lvlSeven(modInt, modCon) {
		...
		this.saves =[ 5, 5, 2 ];
		this.spellsLVL =[ 0, 4, 3, 1, 0, 0, 0, 0, 0, 0 ];
		this.skillPoints = 4 + modInt;
		this.hitPoints = this.rolls.eightSided() + modCon;
	}
	...
	lvlEight(modInt, modCon) {
		...
		this.saves =[ 6, 6, 2 ];
		this.spellsLVL =[ 0, 4, 4, 2, 0, 0, 0, 0, 0, 0 ];
		this.skillPoints = 4 + modInt;
		this.hitPoints = this.rolls.eightSided() + modCon;
	}
	...
	lvlNine(modInt, modCon) {
		this.baseAttackBonus =[ 6, 1, 0, 0 ];
		this.saves =[ 6, 6, 3 ];
		this.spellsLVL =[ 0, 5, 4, 3, 0, 0, 0, 0, 0, 0 ];
		this.skillPoints = 4 + modInt;
		this.hitPoints = this.rolls.eightSided() + modCon;
	}
	...
	lvlTen(modInt, modCon) {
		...
		this.saves =[ 7, 7, 3 ];
		this.spellsLVL =[ 0, 5, 4, 3, 1, 0, 0, 0, 0, 0 ];
		this.skillPoints = 4 + modInt;
		this.hitPoints = this.rolls.eightSided() + modCon;
	}
	...
	lvlEleven(modInt, modCon) {
		...
		this.saves =[ 7, 7, 3 ];
		this.spellsLVL =[ 0, 5, 4, 4, 2, 0, 0, 0, 0, 0 ];
		this.skillPoints = 4 + modInt;
		this.hitPoints = this.rolls.eightSided() + modCon;
	}
	...
	lvlTwelve(modInt, modCon) {
		...
		this.saves =[ 8, 8, 4 ];
		this.spellsLVL =[ 0, 5, 5, 4, 3, 0, 0, 0, 0, 0 ];
		this.skillPoints = 4 + modInt;
		this.hitPoints = this.rolls.eightSided() + modCon;
	}
	...
	lvlThirteen(modInt, modCon) {
		this.baseAttackBonus =[ 9, 4, 0, 0 ];
		this.saves =[ 8, 8, 4 ];
		this.spellsLVL =[ 0, 5, 5, 4, 3, 1, 0, 0, 0, 0 ];
		this.skillPoints = 4 + modInt;
		this.hitPoints = this.rolls.eightSided() + modCon;
	}
	...
	lvlFourteen(modInt, modCon) {
		...
		this.saves =[ 9, 9, 4 ];
		this.spellsLVL =[ 0, 5, 5, 4, 4, 2, 0, 0, 0, 0 ];
		this.skillPoints = 4 + modInt;
		this.hitPoints = this.rolls.eightSided() + modCon;
	}
	...
	lvlFithteen(modInt, modCon) {
		...
		this.saves =[ 9, 9, 5 ];
		this.spellsLVL =[ 0, 5, 5, 5, 4, 3, 0, 0, 0, 0 ];
		this.skillPoints = 4 + modInt;
		this.hitPoints = this.rolls.eightSided() + modCon;
	}
	...
	lvlSixteen(modInt, modCon) {
		...
		this.saves =[ 10, 10, 5 ];
		this.spellsLVL =[ 0, 5, 5, 5, 4, 3, 1, 0, 0, 0 ];
		this.skillPoints = 4 + modInt;
		this.hitPoints = this.rolls.eightSided() + modCon;
	}
	...
	lvlSeventeen(modInt, modCon) {
		this.baseAttackBonus =[ 12, 7, 2, 0 ];
		this.saves =[ 10, 10, 5 ];
		this.spellsLVL =[ 0, 5, 5, 5, 4, 4, 2, 0, 0, 0 ];
		this.skillPoints = 4 + modInt;
		this.hitPoints = this.rolls.eightSided() + modCon;
	}
	...
	lvlEighteen(modInt, modCon) {
		...
		this.saves =[ 11, 11, 6 ];
		this.spellsLVL =[ 0, 5, 5, 5, 5, 4, 3, 0, 0, 0 ];
		this.skillPoints = 4 + modInt;
		this.hitPoints = this.rolls.eightSided() + modCon;
	}
	...
	lvlNineteen(modInt, modCon) {
		...
		this.saves =[ 11, 11, 6 ];
		this.spellsLVL =[ 0, 5, 5, 5, 5, 5, 4, 0, 0, 0 ];
		this.skillPoints = 4 + modInt;
		this.hitPoints = this.rolls.eightSided() + modCon;
	}
	...
	lvlTwenty(modInt, modCon) {
		...
		this.saves =[ 12, 12, 6 ];
		this.spellsLVL =[ 0, 5, 5, 5, 5, 5, 5, 0, 0, 0 ];
		this.skillPoints = 4 + modInt;
		this.hitPoints = this.rolls.eightSided() + modCon;
	}
	...
	getStartingWealth() {
		const diceRolls = this.rolls.multipleRolls(3, 6);
