...
export default class Sorcerer {
	...
	lvlTwo(modInt, modCon) {
		...
		this.saves =[ 0, 0, 3 ];
		this.spellsLVL =[ 0, 4, 0, 0, 0, 0, 0, 0, 0, 0 ];
		this.skillPoints = 2 + modInt;
	...
	lvlThree(modInt, modCon) {
		this.baseAttackBonus =[ 1, 0, 0, 0 ];
		this.saves =[ 1, 1, 3 ];
		this.spellsLVL =[ 0, 5, 0, 0, 0, 0, 0, 0, 0, 0 ];
		this.skillPoints = 2 + modInt;
		this.hitPoints = this.rolls.sixSided() + modCon;
	}
	...
	lvlFour(modInt, modCon) {
		...
		this.saves =[ 1, 1, 4 ];
		this.spellsLVL =[ 0, 6, 3, 0, 0, 0, 0, 0, 0, 0 ];
		this.skillPoints = 2 + modInt;
		this.hitPoints = this.rolls.sixSided() + modCon;
	}
	...
	lvlFive(modInt, modCon) {
		this.baseAttackBonus =[ 2, 0, 0, 0 ];
		this.saves =[ 1, 1, 4 ];
		this.spellsLVL =[ 0, 6, 4, 0, 0, 0, 0, 0, 0, 0 ];
		this.skillPoints = 2 + modInt;
		this.hitPoints = this.rolls.sixSided() + modCon;
	}
	...
	lvlSix(modInt, modCon) {
		...
		this.saves =[ 2, 2, 5 ];
		this.spellsLVL =[ 0, 6, 5, 3, 0, 0, 0, 0, 0, 0 ];
		this.skillPoints = 2 + modInt;
		this.hitPoints = this.rolls.sixSided() + modCon;
	}
	...
	lvlSeven(modInt, modCon) {
		this.baseAttackBonus =[ 3, 0, 0, 0 ];
		this.saves =[ 2, 2, 5 ];
		this.spellsLVL =[ 0, 6, 6, 4, 0, 0, 0, 0, 0, 0 ];
		this.skillPoints = 2 + modInt;
		this.hitPoints = this.rolls.sixSided() + modCon;
	}
	...
	lvlEight(modInt, modCon) {
		...
		this.saves =[ 2, 2, 6 ];
		this.spellsLVL =[ 0, 6, 6, 5, 3, 0, 0, 0, 0, 0 ];
		this.skillPoints = 2 + modInt;
		this.hitPoints = this.rolls.sixSided() + modCon;
	}
	...
	lvlNine(modInt, modCon) {
		this.baseAttackBonus =[ 4, 0, 0, 0 ];
		this.saves =[ 3, 3, 6 ];
		this.spellsLVL =[ 0, 6, 6, 6, 4, 0, 0, 0, 0, 0 ];
		this.skillPoints = 2 + modInt;
		this.hitPoints = this.rolls.sixSided() + modCon;
	}
	...
	lvlTen(modInt, modCon) {
		...
		this.saves =[ 3, 3, 7 ];
		this.spellsLVL =[ 0, 6, 6, 6, 5, 3, 0, 0, 0, 0 ];
		this.skillPoints = 2 + modInt;
		this.hitPoints = this.rolls.sixSided() + modCon;
	}
	...
	lvlEleven(modInt, modCon) {
		this.baseAttackBonus =[ 5, 0, 0, 0 ];
		this.saves =[ 3, 3, 7 ];
		this.spellsLVL =[ 0, 6, 6, 6, 6, 4, 0, 0, 0, 0 ];
		this.skillPoints = 2 + modInt;
		this.hitPoints = this.rolls.sixSided() + modCon;
	}
	...
	lvlTwelve(modInt, modCon) {
		...
		this.saves =[ 4, 4, 8 ];
		this.spellsLVL =[ 0, 6, 6, 6, 6, 5, 3, 0, 0, 0 ];
		this.skillPoints = 2 + modInt;
		this.hitPoints = this.rolls.sixSided() + modCon;
	}
	...
	lvlThirteen(modInt, modCon) {
		this.baseAttackBonus =[ 6, 1, 0, 0 ];
		this.saves =[ 4, 4, 8 ];
		this.spellsLVL =[ 0, 6, 6, 6, 6, 6, 4, 0, 0, 0 ];
		this.skillPoints = 2 + modInt;
		this.hitPoints = this.rolls.sixSided() + modCon;
	}
	...
	lvlFourteen(modInt, modCon) {
		...
		this.saves =[ 4, 4, 9 ];
		this.spellsLVL =[ 0, 6, 6, 6, 6, 6, 5, 3, 0, 0 ];
		this.skillPoints = 2 + modInt;
		this.hitPoints = this.rolls.sixSided() + modCon;
	}
	...
	lvlFithteen(modInt, modCon) {
		this.baseAttackBonus =[ 7, 2, 0, 0 ];
		this.saves =[ 5, 5, 9 ];
		this.spellsLVL =[ 0, 6, 6, 6, 6, 6, 6, 4, 0, 0 ];
		this.skillPoints = 2 + modInt;
		this.hitPoints = this.rolls.sixSided() + modCon;
	}
	...
	lvlSixteen(modInt, modCon) {
		...
		this.saves =[ 5, 5, 10 ];
		this.spellsLVL =[ 0, 6, 6, 6, 6, 6, 6, 5, 3, 0 ];
		this.skillPoints = 2 + modInt;
		this.hitPoints = this.rolls.sixSided() + modCon;
	}
	...
	lvlSeventeen(modInt, modCon) {
		this.baseAttackBonus =[ 8, 3, 0, 0 ];
		this.saves =[ 5, 5, 10 ];
		this.spellsLVL =[ 0, 6, 6, 6, 6, 6, 6, 6, 4, 0 ];
		this.skillPoints = 2 + modInt;
		this.hitPoints = this.rolls.sixSided() + modCon;
	}
	...
	lvlEighteen(modInt, modCon) {
		...
		this.saves =[ 6, 6, 11 ];
		this.spellsLVL =[ 0, 6, 6, 6, 6, 6, 6, 6, 5, 3 ];
		this.skillPoints = 2 + modInt;
		this.hitPoints = this.rolls.sixSided() + modCon;
	}
	...
	lvlNineteen(modInt, modCon) {
		this.baseAttackBonus =[ 9, 4, 0, 0 ];
		this.saves =[ 6, 6, 11 ];
		this.spellsLVL =[ 0, 6, 6, 6, 6, 6, 6, 6, 6, 4 ];
		this.skillPoints = 2 + modInt;
		this.hitPoints = this.rolls.sixSided() + modCon;
	}
	...
	lvlTwenty(modInt, modCon) {
		...
		this.saves =[ 6, 6, 12 ];
		this.spellsLVL =[ 0, 6, 6, 6, 6, 6, 6, 6, 6, 6 ];
		this.skillPoints = 2 + modInt;
		this.hitPoints = this.rolls.sixSided() + modCon;
	}
